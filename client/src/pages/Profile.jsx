      ...
      <div className="flex w-full flex-col items-center justify-center border-[3px] border-slate-400 py-4 lg:h-full lg:w-[40%]">
        ...
        <div className="">
          <div className=" my-2 flex flex-col items-center justify-center ">
            ...
            <p className="mt-1 text-center text-blue-100">{user.userName}</p>
        ...
        <div className="flex items-center justify-center gap-4">
          <div className="grid h-[80px] w-[100px] place-content-center">
            <p className="text-center text-[12px] font-bold text-blue-100">
              No. of Uploads :
            </p>
            <p className="text-center text-5xl font-black text-blue-100">{numberofUploads}</p>
          </div>
          <span className="h-[60px] w-[1px] bg-gray-400" />
          <div className="grid h-[80px] w-[100px] place-content-center">
            <p className="text-center text-[12px] font-bold text-blue-100">No. of Files :</p>
            <p className="text-center text-5xl font-black text-blue-100">{numberofFiles}</p>
          </div>
        </div>
      </div>
      <div className="h-auto w-full border-[3px] border-slate-400 p-5 lg:h-full lg:w-[60%]">
        <h1 className="mb-3 text-xl font-black text-blue-100">My Documents :</h1>
