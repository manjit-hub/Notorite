...
const About = () => {
  return (
    <div className="bg-gray-200 dark:bg-stone-800 h-heightWithoutNavbar flex flex-col items-center justify-start p-5 lg:flex-row">
      ...
      <div className="flex h-full w-full flex-col items-center justify-center">
        <div>
          <h1 className="relative mb-3 text-2xl font-black text-gray-900 dark:text-white before:absolute before:top-[30px] before:h-[3px] before:w-[200px] before:bg-yellow-400">
            About Us
          </h1>
          <p className="mt-1 text-[15px] lg:mt-3 text-gray-700 dark:text-gray-200">
