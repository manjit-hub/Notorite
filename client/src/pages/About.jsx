  ...
  return (
    <div className="h-heightWithoutNavbar flex flex-col items-center justify-start p-5 lg:flex-row">
      ...
      <div className="flex h-full w-full flex-col items-center justify-center">
        <div>
          <h1 className="relative mb-3 text-2xl font-black text-gray-500 before:absolute before:top-[30px] before:h-[3px] before:w-[50px] before:bg-blue-900">
            About Us
          </h1>
          <p className="mt-1 text-[15px] lg:mt-3 text-gray-400">
