    ...
    <footer className="bg-gray-200 dark:bg-stone-900 flex items-center justify-center p-16">
      <div className="flex h-full w-full flex-col gap-10 px-20 lg:flex-row lg:justify-between">
        ...
        <div className="">
          ...
          <ul className="text-gray-600 dark:text-gray-400">
            <li className="mb-1">
              <Link to="/about" className="hover:text-white">+91 9078902XXX</Link>
            </li>
            <li className="mb-1">
              <Link to="/faq" className="hover:text-white">+91 6371101XXX</Link>
            </li>
            <li className="mb-1">
              <Link to="/faq" className="hover:text-white">helpnotorite@gmail.com</Link>
            </li>
          </ul>
        </div>
      </div>
